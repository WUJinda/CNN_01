...
# print("torch's version : {}".format(torch.__version__))

# make sure you have torch package and import it successfully
...
loss_fn = nn.CrossEntropyLoss()  # 自带的损失函数，拿来用
# train
