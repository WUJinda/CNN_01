...
import numpy
import os
from dirpath import traversalDir_FirstDir
dir_list =traversalDir_FirstDir('C:\\Users\\DAREWIN\\Base de donne\\DB LSF Mots\\01_bonjour')

f = open('C:\\Users\\DAREWIN\\Desktop\\data.txt', 'w')
n = 0
sum_img = []
while n < len(dir_list):
    path = 'C:\\Users\\DAREWIN\\Base de donne\\DB LSF Mots\\01_bonjour\\' + str(n+1)
